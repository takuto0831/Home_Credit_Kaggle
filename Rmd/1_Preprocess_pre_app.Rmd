...
bureau <- read_csv("~/Desktop/Home_Credit_Kaggle/csv/previous_application.csv",na = c("XNA","NA","","NaN","?")) %>% 
...
```{r eval=TRUE}
write_csv(app_train,"~/Desktop/Home_Credit_Kaggle/csv_imp/previous_application_imp.csv")
```
