...
bureau <- read_csv("~/Desktop/Home_Credit_Kaggle/csv/POS_CASH_balance.csv",na = c("XNA","NA","","NaN","?")) %>% 
...
```{r eval=TRUE}
write_csv(app_train,"~/Desktop/Home_Credit_Kaggle/csv_imp/POS_CASH_balance_imp.csv")
```
