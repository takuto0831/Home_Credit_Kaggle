...
bureau <- read_csv("~/Desktop/Home_Credit_Kaggle/csv/installments_payments.csv",na = c("XNA","NA","","NaN","?")) %>% 
...
```{r eval=TRUE}
write_csv(app_train,"~/Desktop/Home_Credit_Kaggle/csv_imp/installments_payments_imp.csv")
```
