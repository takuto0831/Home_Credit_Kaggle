...
xgbGrid <- expand.grid(
  ...
  eta = c(0.05, 0.1,0.15,0.20,0.25,0.30),
  gamma = c(0.01,0.1),
  subsample = c(0.3,0.6,0.8),
...
for (i in 1:nrow(xgbGrid)) {
  ...
  write_tsv(tmp,"C:/Users/shiohama/Desktop/Home_Credit_Kaggle/data/tuning_result_feature_100.tsv") # for windows
}
```
